...
DIGEST_STORY_COUNT: int = 12
DIGEST_SCORE_HALFLIFE_HOURS: float = 12.0
DIGEST_DEDUP_THRESHOLD: float = 0.85
DIGEST_SUMMARY_MAX_TOKENS: int = 256
DIGEST_SUMMARY_TEMPERATURE: float = 0.1